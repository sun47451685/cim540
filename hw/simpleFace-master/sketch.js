...
function setup() {
  ...
  img1 = loadImage("png/1.png");
  img2 = loadImage("png/2.png");
  img3 = loadImage("png/3.png");
  img4 = loadImage("png/4.png");
...
function DrawFace(face) {
  ...
  if (face.state === brfv4.BRFState.FACE_TRACKING_START ||
    ...
    image(img4,head[0], head[1]);
    else if(fDS[48][1] * 0.95 < fDS[67][1])
	image(img1,head[0], head[1]);
    else //if(fDS[48][1] * 0.95 > fDS[67][1])
	image(img2,head[0], head[1]);
//else
	//image(img3,head[0], head[1]);
